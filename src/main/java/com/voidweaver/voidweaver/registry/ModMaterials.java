...
/** Tool and armor materials for the two VoidWeaver tiers. */
public final class ModMaterials {
    private ModMaterials() {}

    // Repair-item tags (populated by data/voidweaver/tags/item/*.json).
    public static final TagKey<Item> CHORUS_ALLOY_REPAIR =
            TagKey.create(Registries.ITEM, VoidWeaver.id("chorus_alloy_repair"));
    public static final TagKey<Item> VOID_CRYSTAL_REPAIR =
            TagKey.create(Registries.ITEM, VoidWeaver.id("void_crystal_repair"));
    ...
    // Equipment-asset keys -> assets/voidweaver/equipment/<id>.json layer definitions.
    public static final ResourceKey<EquipmentAsset> CHORUS_ALLOY_ASSET =
            ResourceKey.create(EquipmentAssets.ROOT_ID, VoidWeaver.id("chorus_alloy"));
    public static final ResourceKey<EquipmentAsset> VOID_CRYSTAL_ASSET =
            ResourceKey.create(EquipmentAssets.ROOT_ID, VoidWeaver.id("void_crystal"));
