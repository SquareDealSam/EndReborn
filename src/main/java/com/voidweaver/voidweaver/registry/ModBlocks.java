...
/**
 * Block registration for VoidWeaver. Every block also registers a matching
...
public final class ModBlocks {
    ...
    private static ResourceKey<Block> blockKey(String name) {
        return ResourceKey.create(Registries.BLOCK, VoidWeaver.id(name));
    }

    private static Block finish(String name, ResourceKey<Block> key, Block block) {
        Registry.register(BuiltInRegistries.BLOCK, key, block);
        ResourceKey<Item> itemKey = ResourceKey.create(Registries.ITEM, VoidWeaver.id(name));
    ...
    public static void register() {
        VoidWeaver.LOGGER.info("[VoidWeaver] Registered {} block items.", ITEM_BLOCKS.size());
    }
}
