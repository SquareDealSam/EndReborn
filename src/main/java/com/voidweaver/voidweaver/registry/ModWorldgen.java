...
/**
 * Slots the six VoidWeaver biomes into the End's outer islands via Fabric's
...
public final class ModWorldgen {
    ...
    private static ResourceKey<Biome> key(String name) {
        return ResourceKey.create(Registries.BIOME, VoidWeaver.id(name));
    }
    ...
    public static void register() {
        ...
        VoidWeaver.LOGGER.info("[VoidWeaver] Registered 6 End biomes.");
    }
}
