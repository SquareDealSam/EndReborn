...
public class ChorusSprite extends PathfinderMob {
    ...
    @Override
    protected net.minecraft.sounds.SoundEvent getAmbientSound() { return com.voidweaver.voidweaver.registry.ModSounds.CHORUS_SPRITE_AMBIENT; }

    @Override
    protected net.minecraft.sounds.SoundEvent getHurtSound(net.minecraft.world.damagesource.DamageSource source) { return com.voidweaver.voidweaver.registry.ModSounds.CHORUS_SPRITE_HURT; }

    @Override
    protected net.minecraft.sounds.SoundEvent getDeathSound() { return com.voidweaver.voidweaver.registry.ModSounds.CHORUS_SPRITE_DEATH; }
}
